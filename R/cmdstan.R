...
#' @param parallel_chains Maximum number of MCMC chains to run in parallel.
...
run_cmdstan <- function(model, file, data, inits = NULL,
                        ...
                        chains = 4, warmup = burnin, seed = NULL,
...
#' @param algorithm Algorithm used for fitting. Can be `"meanfield"` or `"fullrank"`.
...
#' @param ... Other arguments passed to [cmdstanr::variational()].
#'
#' @details
#' For more details about ADVI and how the algorithms work, see
#' \href{https://jmlr.org/papers/volume18/16-107/16-107.pdf}{Automatic Differentiation Variational Inference}.
#'
#' @seealso [cmdstanr::variational()]
#'
#' @export
run_cmdstan_advi <- function(model, file, data, inits = NULL, n_draws = 1000,
